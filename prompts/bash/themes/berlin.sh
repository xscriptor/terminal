...
# Palette
x_user_fg=$(__x_fg 221 221 221)
x_host_fg=$(__x_fg 255 255 255)
x_dir_fg=$(__x_fg 204 204 204)
x_git_fg=$(__x_fg 255 255 255)
x_time_fg=$(__x_fg 153 153 153)
x_ok_fg=$(__x_fg 187 187 187)
x_err_fg=$(__x_fg 153 153 153)
