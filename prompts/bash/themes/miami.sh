...
# Palette
x_user_fg=$(__x_fg 255 216 76)
x_host_fg=$(__x_fg 247 241 255)
x_dir_fg=$(__x_fg 71 207 255)
x_git_fg=$(__x_fg 247 241 255)
x_time_fg=$(__x_fg 255 76 139)
x_ok_fg=$(__x_fg 127 255 212)
x_err_fg=$(__x_fg 255 76 139)
x_dim_fg=$(__x_fg 105 103 108)
