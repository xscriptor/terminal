...
# Palette
x_user_fg=$(__x_fg 138 100 8)
x_host_fg=$(__x_fg 26 26 26)
x_dir_fg=$(__x_fg 0 122 158)
x_git_fg=$(__x_fg 26 26 26)
x_time_fg=$(__x_fg 153 0 38)
x_ok_fg=$(__x_fg 0 122 40)
x_err_fg=$(__x_fg 153 0 38)
x_dim_fg=$(__x_fg 77 77 77)
