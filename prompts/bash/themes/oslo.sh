...
# Palette
x_user_fg=$(__x_fg 209 143 82)
x_host_fg=$(__x_fg 230 230 230)
x_dir_fg=$(__x_fg 66 179 194)
x_git_fg=$(__x_fg 230 230 230)
x_time_fg=$(__x_fg 224 85 97)
x_ok_fg=$(__x_fg 140 194 101)
x_err_fg=$(__x_fg 224 85 97)
x_dim_fg=$(__x_fg 79 86 102)
