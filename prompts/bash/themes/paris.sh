...
# Palette
x_user_fg=$(__x_fg 252 229 102)
x_host_fg=$(__x_fg 26 10 48)
x_dir_fg=$(__x_fg 163 243 255)
x_git_fg=$(__x_fg 26 10 48)
x_time_fg=$(__x_fg 252 97 141)
x_ok_fg=$(__x_fg 123 216 143)
x_err_fg=$(__x_fg 252 97 141)
x_dim_fg=$(__x_fg 196 189 255)
