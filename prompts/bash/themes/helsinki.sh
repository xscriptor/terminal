...
# Palette
x_user_fg=$(__x_fg 46 112 173)
x_host_fg=$(__x_fg 84 77 64)
x_dir_fg=$(__x_fg 189 76 61)
x_git_fg=$(__x_fg 84 77 64)
x_time_fg=$(__x_fg 31 170 158)
x_ok_fg=$(__x_fg 115 61 154)
x_err_fg=$(__x_fg 31 170 158)
x_dim_fg=$(__x_fg 176 169 153)
