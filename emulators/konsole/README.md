...
- One-liner:
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/konsole/install.sh | bash
```
...
- Remote one‑liner:
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/konsole/uninstall.sh | bash
# or
curl -fsSL https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/konsole/uninstall.sh | bash
```
- Local:
```bash
