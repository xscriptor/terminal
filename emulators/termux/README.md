...
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/termux/install.sh | bash
# or
curl -fsSL https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/termux/install.sh | bash
```
