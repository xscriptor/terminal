...
```bash
 wget -qO- https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/alacritty/install.sh | bash
```
...
- Remote one‑liner:
```bash
wget -qO- https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/alacritty/uninstall.sh | bash
# or
curl -fsSL https://raw.githubusercontent.com/xscriptor/terminal/main/emulators/alacritty/uninstall.sh | bash
```
- Local:
```bash
